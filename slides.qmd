...
## Research agenda {background-image="img/stephan-cassara-KnAIsBuitGg-unsplash.jpg" background-opacity="0.2"}
...
What are the effects of these changes in gun violence on individuals?

&nbsp;

. . .

**What is driving these changes in the first place?**
...
# [Legal Cynicism, Distrust, and Gun Carrying]{.r-fit-text}{background-image="img/benjamin-suter-mlOvsx4xdaA-unsplash.jpg" background-opacity="0.4"}
...
*2021 was not a reprise of 1999; both were the result of **differential activation** of processes responding to macrosocial context*
...
# Appendix {background-image="img/joel-mott-s-rsM-AktbA-unsplash.jpg" background-opacity="0.4"}
